                ...
                <div style={{ position: 'absolute', inset: 0, zIndex: 20, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '4rem' }}>
                    ...
                    <div style={{ maxWidth: '32rem' }}>
                        <h1 style={{ fontSize: '3rem', fontWeight: 800, color: 'white', marginBottom: '1.5rem', lineHeight: 1.1 }}>
                            Únase a la Innovación en Ingeniería
                        </h1>
                        <p style={{ fontSize: '1.25rem', color: 'rgba(255,255,255,0.8)', fontWeight: 300, lineHeight: 1.6 }}>
                            Cree su cuenta para gestionar sus proyectos y acceder a consultoría especializada de alto nivel.
                        </p>
                    </div>
                ...
                <div style={{ flexGrow: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem' }}>
                    <div style={{ width: '100%', maxWidth: '24rem' }}>
                        ...
                        <div style={{ textAlign: 'left', marginBottom: '2.5rem' }}>
                            <h2 style={{ fontSize: '1.875rem', fontWeight: 800, color: C.navy, marginBottom: '0.5rem' }}>Crear Cuenta</h2>
                            <p style={{ color: '#64748b' }}>Regístrese para comenzar su próximo proyecto.</p>
                        </div>
                        ...
                        {success ? (
                            <div style={{ textAlign: 'center', padding: '2rem', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '16px' }}>
                                <span className="material-symbols-outlined" style={{ fontSize: '3rem', color: '#16a34a', marginBottom: '1rem' }}>mark_email_read</span>
                                <h3 style={{ color: '#166534', fontWeight: 800, marginBottom: '0.5rem' }}>¡Registro Exitoso!</h3>
                                <p style={{ color: '#15803d', fontSize: '0.875rem', marginBottom: '1.5rem' }}>Hemos enviado un correo de confirmación a <strong>{email}</strong>. Por favor, verifique su bandeja de entrada.</p>
                                <Link to="/login" style={{ background: '#16a34a', color: 'white', padding: '0.75rem 1.5rem', borderRadius: '12px', textDecoration: 'none', fontWeight: 700, fontSize: '0.875rem' }}>IR AL INICIO DE SESIÓN</Link>
                            </div>
                        ) : (
                            <>
                                <button
                                ...
                                <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                        <label style={{ fontSize: '0.875rem', fontWeight: 700, color: C.navy }}>Nombre Completo</label>
                                        <div style={{ position: 'relative' }}>
                                            <span className="material-symbols-outlined" style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8', fontSize: '1.25rem' }}>person</span>
                                            <input
                                                type="text"
                                                required
                                                value={name}
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                        <label style={{ fontSize: '0.875rem', fontWeight: 700, color: C.navy }}>Tipo de Usuario</label>
                                        <div style={{ position: 'relative' }}>
                                            <span className="material-symbols-outlined" style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8', fontSize: '1.25rem' }}>badge</span>
                                            <select
                                                required
                                                value={role}
                                                onChange={e => setRole(e.target.value)}
                                                style={{ width: '100%', padding: '1rem 1rem 1rem 3rem', borderRadius: '12px', border: '1px solid #e2e8f0', background: '#f8fafc', outline: 'none', fontFamily: 'Montserrat, sans-serif', appearance: 'none', cursor: 'pointer' }}
                                            >
                                            ...
                                            <span className="material-symbols-outlined" style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8', pointerEvents: 'none' }}>expand_more</span>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" disabled={localLoading} style={{
                                        ...
                                        {localLoading ? 'REGISTRANDO...' : 'REGISTRARME'}
                                    </button>
                                </form>
                            </>
                        )}
                        ...
                        <div style={{ marginTop: '2.5rem', paddingTop: '2rem', borderTop: '1px solid #f1f5f9', textAlign: 'center' }}>
                            <p style={{ fontSize: '0.875rem', color: '#64748b' }}>
                                ¿Ya tiene una cuenta?
                                <Link to="/login" style={{ color: C.teal, fontWeight: 700, textDecoration: 'none', marginLeft: '0.5rem' }}>Inicie sesión aquí</Link>
                            </p>
                        </div>
                    </div>
                </div>
